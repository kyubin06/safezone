...
/* ===== walk ===== */
const EVMETA={
  cctv:{ic:'🎥',bg:'rgba(47,111,237,.12)',col:'#2f6fed',pt:1.2,title:c=>`CCTV 감시구간 · ${c}대`,desc:'이 구간은 CCTV로 감시됩니다. AI가 실시간 영상으로 이상행동을 자동 감지해요.'},
  guard:{ic:'💡',bg:'rgba(240,152,15,.14)',col:'#f0980f',pt:0.6,title:c=>`보안등 밝은구간 · ${c}개`,desc:'보안등이 밝혀 시야가 확보된 구간입니다. 야간 체감 안전도가 높아집니다.'},
  bell:{ic:'🔔',bg:'rgba(239,70,87,.12)',col:'#ef4657',pt:3.5,title:c=>`방범 비상벨`,desc:'위급 상황 시 버튼 한 번으로 관제센터·경찰과 즉시 연결됩니다.'},
