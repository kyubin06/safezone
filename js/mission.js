      ...
      <div class="mz-body">
        <div class="mz-guide">
          ...
          <div class="mz-info">
            ...
            <span class="mz-reward">미션 성공 시 Safe-Point(안심 점수) 상승</span>
          </div>
        </div>
        <div class="mz-btns">
      ...
      <div class="mz-dim"><div class="mz-modal mz-narrow">
        <div class="mz-body" style="padding:34px 30px 30px">
          <div class="mz-success">
            ...
            <div class="mz-succ-sub">정확하게 포즈를 유지했어요. 안심 점수(Safe-Point)에 반영돼요!</div>
            <div class="mz-succ-stats">
              <div class="mz-succ-stat"><div class="v">✓</div><div class="k">안심미션 성공</div></div>
            </div>
