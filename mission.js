...
(function(){
  ...
  function done(success){
    const payload=success?{success:true,reward:curMission.reward,gauge:curMission.gauge}:{success:false};
    close();
      ...
      <div class="mz-body">
        <div class="mz-guide">
          ...
          <div class="mz-info">
            ...
            <span class="mz-reward">미션 성공 시 +${curMission.reward} Safe-Point · SAFE 게이지 상승</span>
          </div>
        </div>
        <div class="mz-btns">
  ...
  function renderCamera(){
    ...
    <div class="mz-dim"><div class="mz-modal mz-wide">
      <div class="mz-head">
        ...
        <p>온몸(양어깨·양팔)이 화면 안에 들어오게 서서, 포즈를 <b>${HOLD_SEC}초간</b> 유지하면 자동으로 성공 처리돼요.</p>
      </div>
      <div class="mz-body">
        <div class="mz-cam">
      ...
      <div class="mz-dim"><div class="mz-modal mz-narrow">
        <div class="mz-body" style="padding:34px 30px 30px">
          <div class="mz-success">
            ...
            <div class="mz-succ-sub">정확하게 포즈를 유지했어요. Safe-Point가 적립되고 SAFE 게이지가 올랐어요!</div>
            <div class="mz-succ-stats">
              <div class="mz-succ-stat"><div class="v">+${curMission.reward} P</div><div class="k">획득 Safe-Point</div></div>
              <div class="mz-succ-stat"><div class="v">+${curMission.gauge}</div><div class="k">SAFE 게이지</div></div>
            </div>
